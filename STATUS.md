...
4. **Segunda opción de visualización por proyecto**: ⏸️ BLOQUEADA — pendiente de que el usuario redacte los resúmenes/conclusiones de cada proyecto. Decisión de diseño ya tomada (2026-06-16): **Opción B** — la tarjeta sigue siendo un `<a>` a GitHub; se añade un segundo icono junto al de GitHub (ojo o documento) para abrir la vista de resumen (modal o página individual, por decidir una vez haya contenido).
